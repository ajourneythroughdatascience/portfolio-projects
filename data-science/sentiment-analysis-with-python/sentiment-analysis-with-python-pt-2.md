...
- [Preprocessing](#preprocessing)
          - [*Figure 1: Data Preprocessing General Structure*](#figure-1-data-preprocessing-general-structure)
          - [Figure 2: Data Preprocessing Structure Chart](#figure-2-data-preprocessing-structure-chart)
        - [**Code**](#code)
        - [**Code**](#code-1)
        - [**Code**](#code-2)
  - [1. downloadData](#1-downloaddata)
        - [**Code**](#code-3)
  - [2. readMode](#2-readmode)
        - [**Code**](#code-4)
    - [2.1 selectCols](#21-selectcols)
        - [**Code**](#code-5)
    - [2.2 castTypes](#22-casttypes)
        - [**Code**](#code-6)
    - [2.3 readData](#23-readdata)
        - [**Code**](#code-7)
        - [**Code**](#code-8)
- [Sentiment analysis package](#sentiment-analysis-package)
  ...
  - [2. Sentiment analysis](#2-sentiment-analysis)
          - [*Figure 3: Sentiment Analysis Execution Process Flow*](#figure-3-sentiment-analysis-execution-process-flow)
          - [*Figure 4: Detailed Sentiment Analysis Execution Structure Chart*](#figure-4-detailed-sentiment-analysis-execution-structure-chart)
        - [**Code**](#code-12)
        - [**Code**](#code-13)
    - [2.1 applyModel](#21-applymodel)
        - [**Code**](#code-14)
    - [2.2 executeModel](#22-executemodel)
        - [**Code**](#code-15)
        - [**Code**](#code-16)
