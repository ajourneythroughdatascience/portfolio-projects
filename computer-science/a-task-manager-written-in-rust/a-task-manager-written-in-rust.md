<article class="first">
  <div class="title">
    <h1>A Task Manager Written in Rust</h1>
  </div>
</article>
...
We'll be using Python scripts which can be found in the [Portfolio Project Repo](https://github.com/pabloagn/blog/tree/master/computer-science/programming-best-practices-writing-better-code).
...
- Rust as Back End
- PostgreSQL as DB
- Native Web Components as Front End (Frameworkless)

1. Install Rust Lang
2. Install Rust Analyzer VS Code extension



TUTORIAL:
https://www.youtube.com/watch?v=VIig9IcQ-w8
